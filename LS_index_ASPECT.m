...
%% LS index for ASPECT output
% % read in file
% % % Griggs path
% path = '/Users/tian_bc/Documents/2024-LC_delamination/Model_results/GriggsExp/Andromeda/240724-Griggs-shear-5_particles/240724-Griggs-shear-5particles/particles_cpo'
% filename='test-step90-particle2.dat'


path = '/Users/tian_bc/Documents/2024-LC_delamination/Model_results/GriggsExp/Andromeda/240724-Griggs-shear-5_particles/240724-Griggs-shear-5particles/particles_cpo/test-Vol-weighted-step90/data_files'
% for particle 0
filename='weighted_CPO-00090.0109.dat'
% % for particle 1
% filename='weighted_CPO-00090.0037.dat'
% % for particle 2
 filename='weighted_CPO-00090.0060.dat'
% % for particle 3
% filename='weighted_CPO-00090.0050.dat'
% % for particle 4
% filename='weighted_CPO-00090.0046.dat'


% % shear box path;
% path = '/Users/tian_bc/Documents/postdoc/postdoc_meetings_workshops/2024-05-ASPECT-hack/aspect-output/drex-CPX-test/out_shear_compress6_refined10-bugfixed/particles_cpo'
% filename='weighted_CPO-00050.0000.dat'
% 
% % unicompress box
% path='/Users/tian_bc/Documents/postdoc/postdoc_meetings_workshops/2024-05-ASPECT-hack/aspect-output/drex-CPX-test/out_uniaxial_compress/particles_cpo'
% filename='weighted_CPO-00006.0000.dat'
